                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('wisata.update', $wisata->id) }}" method="post">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Informasi Objek Wisata</label>
                                <textarea class="form-control  @error('informasi_wisata') is-invalid @enderror" name="informasi_wisata">{{ $wisata->informasi_wisata }}</textarea>
